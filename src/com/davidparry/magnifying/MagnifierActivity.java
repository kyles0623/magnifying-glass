...
public class MagnifierActivity extends Activity implements OnTouchListener,
	...
	protected void showWhatsNewDialog() {
		...
		final View textEntryView = factory.inflate(
				com.davidparry.magnifying.R.layout.whats_new, null);
	...
	protected void checkForFlash() {
		ImageView liteClick = (ImageView) findViewById(R.id.flash);
		Parameters parm = getParameters();
		if (parm != null) {
	...
	private void showInstruction() {
		...
		View textEntryView = factory.inflate(
				com.davidparry.magnifying.R.layout.instruction, null);
